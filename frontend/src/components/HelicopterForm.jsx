...
// Ikonlar (Ikon SVG kodları aynı kalacak)
...
export function HelicopterForm() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800/50 rounded-2xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700 shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="overflow-hidden" autoComplete="off">
        <AnimatePresence mode="wait">
          {step === 1 && (
            <motion.div key="step1" variants={formVariants} initial="hidden" animate="visible" exit="exit" transition={{ duration: 0.3 }} className="space-y-4">
              <InputField label="Kalkış" error={errors.departure}>
                ...
                <select name="departure" value={formData.plan.departure} onChange={handlePlanChange} className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent outline-none appearance-none text-gray-900 dark:text-white" autoComplete="off">
              ...
              <InputField label="Varış" error={errors.arrival}>
                ...
                <select name="arrival" value={formData.plan.arrival} onChange={handlePlanChange} className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent outline-none appearance-none text-gray-900 dark:text-white" autoComplete="off">
                  {airports.map(a => <option key={a.code} value={a.code}>{a.name}</option>)}
                </select>
              </InputField>
              <div className="grid grid-cols-2 gap-4">
                <InputField label="Tarih" error={errors.date}>
                  ...
                  <input type="date" name="date" min={today} value={formData.plan.date} onChange={handlePlanChange} className="w-full pl-10 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent outline-none text-gray-900 dark:text-white" autoComplete="off"/>
                </InputField>
                <InputField label="Yolcu" error={errors.passengers}>
                  ...
                  <input type="number" name="passengers" value={formData.plan.passengers} onChange={handlePlanChange} min="1" max="12" className="w-full pl-10 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent outline-none text-gray-900 dark:text-white" autoComplete="off" />
                </InputField>
              </div>
          ...
          {step === 2 && (
            <motion.div key="step2" variants={formVariants} initial="hidden" animate="visible" exit="exit" transition={{ duration: 0.3 }} className="space-y-4">
              <InputField label="Ad Soyad" error={errors.name}><input type="text" name="name" value={formData.contact.name} onChange={handleContactChange} className="w-full p-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent outline-none text-gray-900 dark:text-white" autoComplete="off" /></InputField>
              <InputField label="E-posta" error={errors.email}><input type="email" name="email" value={formData.contact.email} onChange={handleContactChange} className="w-full p-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent outline-none text-gray-900 dark:text-white" autoComplete="off" /></InputField>
              <InputField label="Telefon (Opsiyonel)"><input type="tel" name="phone" value={formData.contact.phone} onChange={handleContactChange} className="w-full p-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent outline-none text-gray-900 dark:text-white" autoComplete="off" /></InputField>
              <InputField label="Notunuz (Opsiyonel)"><textarea name="note" value={formData.contact.note} onChange={handleContactChange} rows="3" className="w-full p-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent outline-none text-gray-900 dark:text-white" autoComplete="off"></textarea></InputField>
